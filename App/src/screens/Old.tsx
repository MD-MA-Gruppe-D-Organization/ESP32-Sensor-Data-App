            ...
            <TouchableWithoutFeedback onPress={toggleExpansion}>
                <View style={styles.card}>
                    ...
                    >
                        ...
                        {/* View History button */}
                        <TouchableOpacity style={styles.viewHistoryButton} onPress={() => console.log('View History pressed')}>
                            <Text style={styles.viewHistoryText}>See History</Text>
                        </TouchableOpacity>
                    </Animated.View>
                </View>
...
const styles = StyleSheet.create({
    ...
    expandableContent: {
        ...
        marginLeft: 10, // Added margin to separate from the bar
        padding: 10,
    ...
    viewHistoryButton: {
        marginTop: 10, // Added margin to separate from the expandable content
